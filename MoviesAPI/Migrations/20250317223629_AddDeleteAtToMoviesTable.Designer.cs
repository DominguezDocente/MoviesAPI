...
namespace MoviesAPI.Migrations
{
    ...
    [Migration("20250317223629_AddDeleteAtToMoviesTable")]
    partial class AddDeleteAtToMoviesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoviesAPI.Entities.APIKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviesAPI.Entities.APIRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviesAPI.Entities.CinemaRoom", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-75.60411563077764 6.233287313258494)"),
                            Name = "Cine Colombia los Molinos"
                        },
                        new
                        {
                            Id = 6,
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-75.59094136146099 6.176432492851308)"),
                            Name = "Viva envigado Mall"
                        },
                        new
                        {
                            Id = 7,
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-73.98605334286276 40.73121176677272)"),
                            Name = "Village East Cinema"
                        });
                });

            modelBuilder.Entity("MoviesAPI.Entities.DomainRestriction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviesAPI.Entities.IPRestriction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviesAPI.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("LimitPaymentDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MoviesAPI.Entities.IssuedInvoice", b =>
                {
            ...
            modelBuilder.Entity("MoviesAPI.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("DefaultingDebtor")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MoviesAPI.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MoviesAPI.Entities.APIRequest", b =>
                {
                    b.HasOne("MoviesAPI.Entities.APIKey", "APIKey")
                        .WithMany()
